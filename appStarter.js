...
const url_moduls = "https://cdn.jsdelivr.net/gh/tafirnat02/pullWorts@main/wortApp/_importModuls_n17.js"
//modul dosya durumu kontrol edilir
 ...
 function loadModuls(){return new Promise((resolve)=>{let head_ =
   ...
   scrpt.type = "module";scrpt.src = url_moduls;document.head.appendChild(scrpt);
 head_.insertBefore(scrpt, head_.lastChild);resolve()});}

function existFile(url){
if(typeof runApp !== 'undefined') runApp()
...
http.open('HEAD', url, false);http.send();
 ...
 if (existFile(url_moduls)) loadModuls.call()
